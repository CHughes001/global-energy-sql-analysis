...
CREATE VIEW urbanization_energy_1 AS
SELECT 
    u.country,
    u.year,
...
FROM 
    urbanization_clean_1 u
JOIN 
    energy_clean_1 e ON u.country = e.country AND u.year = e.year;  --merges table based on matching country and year
